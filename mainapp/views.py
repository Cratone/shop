...
from .models import Category, Customer, Cart, CartProduct, Product, Order, Comment
...
def leave_comment(request, slug):
    ...
    new_comment = Comment.objects.create(author=request.POST['name'], text=request.POST['text'], product=product)
